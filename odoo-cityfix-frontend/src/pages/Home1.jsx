...
const nearbyReports = [
  {
    ...
    status: "Reported",
    imageUrl:
      "https://images.unsplash.com/photo-1588821321573-a25a3b37a83c?q=80&w=800&auto=format&fit=crop",
    priority: "High",
    timeAgo: "2 hours ago",
    upvotes: 12,
  },
  ...
  },
  {
    ...
    status: "Resolved",
    imageUrl:
      "https://images.unsplash.com/photo-1604735533923-7e4b524512d7?q=80&w=800&auto=format&fit=crop",
    priority: "Medium",
    timeAgo: "3 days ago",
    upvotes: 8,
  },
...
const features = [
  {
    ...
    description: "See issues within a 3-5km radius.",
  },
  {
    icon: "🔄",
...
const BeforeAfterSlider = ({ beforeImg, afterImg }) => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full max-w-4xl mx-auto aspect-[16/10] rounded-2xl overflow-hidden select-none cursor-ew-resize shadow-2xl shadow-teal-900/20"
    >
      <motion.div
    ...
    <section className="relative h-screen flex items-center justify-center text-white overflow-hidden">
      ...
      >
        ...
        >
          ...
          change. CityFix connects you to a better neighborhood.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <Link
            to="/login"
            className="inline-flex items-center justify-center w-full sm:w-auto px-8 py-4 text-base font-semibold text-white bg-teal-500 rounded-lg shadow-lg hover:bg-teal-600 transform hover:-translate-y-1 transition-all"
          >
            Report an Issue Now
          </Link>
          <Link
            to="/login"
            className="inline-flex items-center justify-center w-full sm:w-auto px-8 py-4 text-base font-semibold text-white bg-white/10 border border-white/20 rounded-lg backdrop-blur-sm hover:bg-white/20 transform hover:-translate-y-1 transition-all"
          >
            View Nearby Reports
          </Link>
        </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600">
            Live updates on issues reported by your neighbors.
          </p>
        </motion.div>
            ...
            >
              <div className="relative">
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  <span className="text-sm font-semibold bg-teal-500/80 px-3 py-1 rounded-full">
                    {report.category}
                  </span>
