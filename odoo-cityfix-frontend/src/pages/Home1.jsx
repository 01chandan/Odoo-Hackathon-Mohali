...
import { ArrowRight, CheckCircle, Users, Zap, Heart, ChevronDown, MoveHorizontal, MapPin, Clock, AlertTriangle, Camera, Send, TrendingUp, Globe, Leaf } from 'lucide-react';
import "../index.css";
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
      ...
      <motion.div style={{ y, opacity }} className="relative z-10 text-center px-6 max-w-6xl mx-auto">
        ...
        >
          <motion.span variants={wordVariants} className="block">CityFix</motion.span>
        ...
        >
          Report local issues, track their resolution, and be part of the change. 
          <span className="text-teal-300"> Connect your community</span> to a better future.
        </motion.p>
...
const NearbyReportsSection = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case 'Reported': return 'bg-yellow-500/10 text-yellow-400 border-yellow-500/20';
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Stay connected with local issues and see real-time updates from your community members.
          </p>
        </motion.div>
...
const ImpactSection = () => {
  ...
  return (
    <section ref={ref} className="py-24 bg-gradient-to-br from-teal-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={isInView ? { opacity: 1, y: 0 } : {}}
        ...
        >
          ...
          <h2 className="text-5xl font-bold text-gray-900 mb-6">
            Our Contribution to a <span className="text-teal-600">Cleaner World</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Every report, every resolution, every community action contributes to building sustainable, 
            responsive cities for future generations.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {impactStats.map((stat, index) => (
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">{stat.title}</h3>
              <p className="text-gray-600 mb-4 max-w-sm mx-auto">{stat.description}</p>
              <div className="text-4xl font-black text-teal-600 mb-1">{stat.metric}</div>
